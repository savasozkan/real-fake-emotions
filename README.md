...
* Execute "make" on command line to build the code. It will create "svm" binary file.
* Run "svm" binary file to visualize the validation and test results. 

Further detail about our method will be provided soon.
