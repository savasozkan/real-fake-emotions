...
def compact_bilinear_pooling_layer(bottom1, bottom2, in_size, output_dim, sum_pool=True,
    ...
    input_dim1 = in_size #bottom1.get_shape().as_list()[-1]
    input_dim2 = in_size #bottom2.get_shape().as_list()[-1]
